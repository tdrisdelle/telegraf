...
// Generates a pointer to a YouTube object that uses a mock HTTP client.
// Parameters:
//     response  : Body of the response that the mock HTTP client should return
//     statusCode: HTTP status code the mock HTTP client should return
//
// Returns:
//     *HttpJson: Pointer to a YouTube object that uses the generated mock HTTP client
func genMockYouTube(response string, statusCode int) []*HttpJson {
	return []*YouTube{
		&YouTube{
...
func TestYouTube200(t *testing.T) {
...
func TestYouTubeGET_URL(t *testing.T) {
	...
	a := YouTube{
		Servers: []string{ts.URL + "?key=mykey"},
		Name:    "",
		Method:  "GET",
...
func TestYouTubeGET(t *testing.T) {
...
func TestYouTubePOST(t *testing.T) {
	params := map[string]string{
		"api_key": "mykey",
	}
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func TestHYouTube500(t *testing.T) {
...
func TestYouTubenBadMethod(t *testing.T) {
	youtube := genMockHttpJson(validJSON, 200)
	youtube[0].Method = "NOT_A_REAL_METHOD"

	var acc testutil.Accumulator
	err := acc.GatherError(youtube[0].Gather)
...
func TestYouTubeBadJson(t *testing.T) {
	youtube := genMockYouTube(invalidJSON, 200)
...
func TestYouTubeEmptyResponse(t *testing.T) {
	youtube := genMockYouTube(empty, 200)
...
// Test that the proper values are ignored or collected
func TestYouTube200Tags(t *testing.T) {
	youtube := genMockYouTube(validJSONTags, 200)

	for _, service := range youtube {
...
func TestYouTubeArray200Tags(t *testing.T) {
	youtube := genMockYouTube(validJSONArrayTags, 200)
...
// TestYouTubeBOM tests that UTF-8 JSON with a BOM can be parsed
func TestYouTubeBOM(t *testing.T) {
	youtube := genMockYouTube(string(jsonBOM), 200)
